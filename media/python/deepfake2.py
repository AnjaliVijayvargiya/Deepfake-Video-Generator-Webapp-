...
source_image = imageio.imread('media/'+sys.argv[1])
reader = imageio.get_reader('media/'+sys.argv[2])
...
#save video
imageio.mimsave('media/generated1/'+ 'generatednew.mp4', [img_as_ubyte(frame) for frame in predictions], fps=fps)

#HTML(display(source_image, driving_video, predictions).to_html5_video())

from moviepy.editor import *

clip1 = VideoFileClip('media/generated1/'+ 'generatednew.mp4')
clip2 = VideoFileClip('media/'+sys.argv[2])

img = ['media/'+sys.argv[1]]
...
final_new.write_videofile('media/generated1/'+'merge1.mp4')
